...
export const UserRestrictionIdSchema = publicIdSchema(PUBLIC_ID_PREFIX.userRestriction)
...
export type UserRestrictionId = z.infer<typeof UserRestrictionIdSchema>
